...
def evaluate(board: chess.Board) -> int:
    ...
    for piece_type in (chess.PAWN, chess.KNIGHT, chess.BISHOP, chess.ROOK, chess.QUEEN, chess.KING):
        ...
        phase += PHASE_WEIGHTS[piece_type] * (len(white_squares) + len(black_squares))

        for sq in white_squares:
            mg_score += PIECE_VALUES_MG[piece_type] + _pst_value(PST_MG[piece_type], sq, True)
            eg_score += PIECE_VALUES_EG[piece_type] + _pst_value(PST_EG[piece_type], sq, True)
